...
* Draw the necessary architecture diagrams for the project.
...
* Completed both the system architecture diagram and the Security Group mapping.
* Know how to remote management for EC2 instances located in private subnets via AWS Systems Manager Session Manager.
* Discovered how to deploy a single Regional NAT Gateway to optimize costs while maintaining High Availability (HA) across Availability Zones.